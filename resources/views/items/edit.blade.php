...
<head>
  ...
  <title>Edit Item - Fashion Store</title>
  ...
  <div class="container container-narrow page-wrap">
    <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-2">
      <div>
        ...
        <div class="page-sub">Update product details, price, and stock</div>
      </div>
    ...
    <div class="panel">
      ...
      <div class="p-4 p-md-5">
        ...
        <form action="{{ route('items.update', $item->id) }}" method="POST" class="needs-validation" novalidate>
          @csrf
          @method('PUT')
          ...
          <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
              ...
              <select name="category" class="form-select">
                ...
                <option value="Shirts" {{ old('category', $item->category) == 'Shirts' ? 'selected' : '' }}>Shirts</option>
                <option value="Pants" {{ old('category', $item->category) == 'Pants' ? 'selected' : '' }}>Pants</option>
                <option value="Shoes" {{ old('category', $item->category) == 'Shoes' ? 'selected' : '' }}>Shoes</option>
                <option value="Accessories" {{ old('category', $item->category) == 'Accessories' ? 'selected' : '' }}>Accessories</option>
                <option value="Dresses" {{ old('category', $item->category) == 'Dresses' ? 'selected' : '' }}>Dresses</option>
              </select>
            ...
            <div class="col-12">
              ...
              <textarea name="description" class="form-control" rows="4" placeholder="Short description for the product...">{{ old('description', $item->description) }}</textarea>
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" name="color" class="form-control" value="{{ old('color', $item->color) }}" placeholder="e.g. Red, Blue, Black">
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="hint">Optional (if you use status column).</div>
            </div>

            <div class="col-12 d-flex flex-column flex-sm-row gap-2 mt-2">
              <button type="submit" class="btn btn-save">
                <i class="bi bi-save2 me-1"></i> Update Item
              </button>
